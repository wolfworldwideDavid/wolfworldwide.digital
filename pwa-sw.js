const CACHE_VERSION = '1.7.55.3';

const BASE_CACHE_FILES = [
    'https://wolfworldwide.digital/wp-content/plugins/pwa-for-wp/images/logo.png',
'wp-content/plugins/pwa-for-wp/images/logo-512x512.png',
'wp-content/plugins/pwa-for-wp/images/logo-512x512.png',
'wolfchat/index.html',
'creative-digital-marketing/index.html',
'digital-project-manager-near-me/index.html',
'free-seo-plugin-best-wordpress-seo-plugin/index.html',
'the-importance-of-the-dutch-language-in-globalization-2023/index.html',

];

const OFFLINE_CACHE_FILES = [
     'https://wolfworldwide.digital',
];

const NOT_FOUND_CACHE_FILES = [
    'https://wolfworldwide.digital/error-404/',
];

const OFFLINE_PAGE = 'index.html';
const NOT_FOUND_PAGE = 'error-404/index.html';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://wolfworldwide.digital/wp-admin/');
//    },
];
...
function pwaForWpgetFileExtension(url) {
    ...
    if (typeof url === 'string') {
        ...
        return (extension.endsWith('index.html')) ? '/' : extension;
